...
class UserAdminConfig(UserAdmin):
    ...
    list_display = ('id', 'email', 'first_name', 'last_name',
                    'is_active', 'is_staff', 'is_verified', 'is_admin', 'is_superuser', 'date_joined')
    fieldsets = (
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'first_name', 'last_name', 'password1', 'password2', 'is_active', 'is_staff', 'is_verified', 'is_admin', 'is_superuser')}
         ),
    )
