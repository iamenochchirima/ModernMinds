      ...
      <div className="mt-24 mb-10 flex justify-center">
        <div className="w-3/4">
          ...
          <div className="text-gray-800">
            <p>
              Your privacy is important to us. It is Modern Minds Magazine&#39;s
              ...
              <a
                ...
                href="https://www.modernmindsmag.com"
              >
                https://www.modernmindsmag.com
              </a>
              , and other sites we own and operate.{" "}
            </p>
            <p className="pt-5">
              This policy is effective as of 4 April 2023 and was last updated
              on 4 April 2023.{" "}
            </p>
            ...
            <h4 className="py-5 text-lg font-graphikSemiBold">Log Data</h4>
            <p>
            ...
            <h4 className="font-graphikSemiBold text-xl py-5">
            ...
            <h4 className="font-graphikSemiBold py-5 text-xl">
            ...
            <h4 className="text-xl font-graphikSemiBold py-5">
            ...
            <ul className="list-disc px-10">
              ...
              <li>
                for security and fraud prevention, and to ensure that our site
                is safe, secure, and used in line with our terms of use
              </li>
            </ul>
            <p className="py-5">
            ...
            <h4 className="font-graphikSemiBold pb-5 text-xl">
            ...
            <h4 className="py-5 font-graphikSemiBold text-xl">
            ...
            <p className="pb-5">
              You have the right to view, edit or delete the personal data we
              have collected about you. Furthermore, you have the right to
              withdraw consent or to object to the processing of your personal
              data. And you have the right to data portability: this means that
              you can request that we send you, or another organization named by
              you, the personal data that we have about you in a computer file.
            </p>
            <p>
            ...
            <h3 className="font-graphikSemiBold pb-5 text-xl">Contact Us</h3>
            <p>
              For any questions or concerns regarding your privacy, you may
              contact us using the following details{" "}
              <a
                className="text-blue-600 underline"
                href="https://www.modernmindsmag.com/contact"
              >
                here
              </a>
            </p>
